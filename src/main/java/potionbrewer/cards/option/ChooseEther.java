...
public class ChooseEther extends AbstractCard {
    public static String ID = PotionbrewerMod.makeID(ChooseEther.class.getSimpleName());
    ...
    public void onChoseThisOption() {
        this.addToBot(new ChannelAction(new Ether()));
    }

    @Override
    public AbstractCard makeCopy() {
        return new ChooseEther();
    }
}
