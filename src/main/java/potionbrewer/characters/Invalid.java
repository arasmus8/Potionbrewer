...
public class Invalid extends AbstractPlayer {
    public static class Enums {
        @SpireEnum
        public static PlayerClass INVALID_PLAYER_CLASS;
    }

    public Invalid(String name, PlayerClass setClass) {
        super("INVALID", Enums.INVALID_PLAYER_CLASS);
    }
