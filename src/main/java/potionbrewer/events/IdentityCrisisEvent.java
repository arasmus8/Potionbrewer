...
public class IdentityCrisisEvent extends AbstractImageEvent {
    ...
    public static final String ID = PotionbrewerMod.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("potionbrewerResources/images/events/IdentityCrisisEvent2.png");
